...
| Annotations优化 | 支持默认annotation显示和多annotation输入格式 | v0.1.16 | ✅ 已验证 |
...
| v0.1.15 | 2026-03-30 | 面板响应式加载优化，修复HTML标签错误 |
| v0.1.16 | 2026-03-30 | Annotations优化，支持默认annotation显示和多annotation输入格式 |
