...
start "Ontology Service" cmd /k "cd ontology-service && mvn spring-boot:run"

echo 启动 Class Service...
start "Class Service" cmd /k "cd class-service && mvn spring-boot:run"

echo 启动 Property Service...
start "Property Service" cmd /k "cd property-service && mvn spring-boot:run"

echo 启动 Instance Service...
start "Instance Service" cmd /k "cd instance-service && mvn spring-boot:run"

echo 启动 Reasoning Service...
start "Reasoning Service" cmd /k "cd reasoning-service && mvn spring-boot:run"
...
start "Version Service" cmd /k "cd version-service && mvn spring-boot:run"
